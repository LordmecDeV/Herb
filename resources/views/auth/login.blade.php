...
background-image: linear-gradient(160deg, #4F4F4F 0%, #4F4F4F 100%);
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="{{ route('login.post') }}" method="POST">
					...
					<a href="{{ url('/login/google') }}"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/2048px-Google_%22G%22_Logo.svg.png" style="max-width: 100%;height: 200px;display: block; margin-left:auto;margin-right:auto;" alt="logo-zarpo-320x132-transparente" border="0"></a>
					</div>
					...
					<div class="text-right p-t-13 p-b-23">
						...
						<button class="login100-form-btn" style="margin-bottom:30px;" type="button">
						<a href="{{ url('/login/google') }}" style="color:white;text-decoration:none;font-size:16px;">
    					{{ __('Entrar com Google') }}
						</a><svg style="margin-left:10px;" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">

...
<body>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4" style="margin-top:50px;margin-left:px;margin-bottom:50px;">
                <div class="col">
                <div class="card w-80 mb-3 shadow p-3  bg-body rounded" style="">
                <img src="{{ asset('imagens/undraw_empty_cart_co35.png')}}" style="height:493px;" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">Solicitação de compra</h5>
                <p class="card-text"></p>
                <a href="{{route('solicitacaoDeCompra')}}" class="btn btn" style="background-color:#0098F0;color:white;">Abrir chamado</a>
                </div>
                </div>
                </div>
                ...
                <img src="{{ asset('imagens/undraw_Credit_card_payments_re_qboh.png')}}" style="height:493px;" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">Reembolso</h5>
                <p class="card-text"></p>
                <a href="{{route('reembolso')}}" class="btn btn" style="background-color:#0098F0;color:white;">Abrir chamado</a>
                </div>
                </div>
                </div>

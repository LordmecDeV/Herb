...
<body>
            ...
            <div class="row row-cols-8" style="margin-top:100px;margin-left:px;">
                ...
                <img src="{{ asset('imagens/undraw_Lives_matter_38lv (1).png')}}" style="height:350px;" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">Recursos Humanos</h5>
                <p class="card-text"></p>
                <a href="{{route('homeDpto')}}" class="btn btn" style="background-color:#0098F0;color:white;">Abrir chamado</a>
                </div>
                </div>
                </div>
                ...
                <div class="col">
                <div class="card w-80 shadow-lg p-3 bg-body rounded">
                <img src="{{ asset('imagens/undraw_Savings_re_eq4w (1).png')}}" style="height:350px;" class="card-img-top" alt="...">
                <div class="card-body">
                <h5 class="card-title">Financeiro</h5>
                <p class="card-text"></p>
                <a href="{{route('financeiroMenu')}}" class="btn btn" style="background-color:#0098F0;color:white;">Abrir chamado</a>
